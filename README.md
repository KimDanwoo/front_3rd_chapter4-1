...
<div style="display: flex; justify-content: space-around;">
  <div>
    <h4>S3</h4>
    <img src="./app/assets/images/s3.png" width="95%" alt="S3 성능"/>
  </div>
  <div>
    <h4>CloudFront</h4>
    <img src="./app/assets/images/cloudFront.png" width="95%" alt="CloudFront 성능"/>
  </div>
</div>
...
# S3에서 CloudFront 전환 성능 분석 보고서

## 1. 주요 성능 지표 비교

| 구분           | S3 (전환 전) | CloudFront (전환 후) | 개선율     |
| -------------- | ------------ | -------------------- | ---------- |
| 응답 코드      | 200 (전체)   | 304 (캐시)           | -          |
| 평균 파일 크기 | 22.9KB       | 263B                 | 98.8% 감소 |
| 평균 로딩 시간 | 102초        | 19초                 | 81.4% 감소 |

## 2. 리소스별 개선 효과

| 리소스 타입 | S3 크기/시간   | CloudFront 크기/시간 | 개선율        |
| ----------- | -------------- | -------------------- | ------------- |
| JavaScript  | 801B / 158초   | 241B / 19초          | 69.9% / 88.0% |
| 이미지      | 17.1KB / 16초  | 13.5KB / 3초         | 21.1% / 81.3% |
| CSS         | 235KB / 102초  | 261B / 9초           | 99.9% / 91.2% |
| 폰트        | 16.6KB / 172초 | 297B / 10초          | 98.2% / 94.2% |

## 3. 주요 개선사항

- 304 응답을 통한 캐시 활용으로 불필요한 데이터 전송 감소
- 전체적인 로딩 시간 81.4% 감소
- 특히 정적 리소스(CSS, 폰트)에서 90% 이상의 성능 개선
- 사용자 경험 품질 크게 향상
